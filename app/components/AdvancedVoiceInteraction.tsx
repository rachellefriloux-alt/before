...
export default function AdvancedVoiceInteraction({
    ...
    const getVoiceForPersonality = () => {
        // Map personality to appropriate voice identifier
        const voiceMap = {
            tough_love: 'en-US-ziraRUS', // Direct, assertive voice
            soul_care: 'en-US-ariaRUS',  // Warm, caring voice
            wise_sister: 'en-US-ziraRUS', // Wise, balanced voice
            balanced: 'en-US-ariaRUS',   // Balanced, approachable voice
        };

        return voiceMap[personality as keyof typeof voiceMap] || 'en-US-ariaRUS'; // Default to warm voice
    };
